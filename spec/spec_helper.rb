...
def dist_path
  File.expand_path "../lib/bunto-admin/public/", File.dirname(__FILE__)
end
...
def in_source_dir(questionable_path)
  Bunto.sanitized_path BuntoAdmin.site.source, questionable_path
end
...
config = Bunto.configuration("source" => fixture_path("site"))
